            ...
            <nav className="navbar header-nav">
                ...
                <div className={'navbar-menu' + (isActive ? ' is-active' : '')}>
                    <div className="navbar-end">
                        ...
                        <Link className="navbar-item" onClick={() => setActive(false)} to="/who">Quem somos nós?</Link>
                        <Link className="navbar-item" onClick={() => setActive(false)} to="/concluded">Trabalhos concluídos</Link>
                        <Link className="navbar-item" onClick={() => setActive(false)} to="/contact">Contato</Link>
                    </div>
                </div>
            </nav>
        </>
